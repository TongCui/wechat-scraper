...
+ (instancetype)KIFErrorWithFormat:(NSString *)format, ...
{
    ...
    return [self errorWithDomain:@"KIFTest" code:1234 userInfo:@{NSLocalizedDescriptionKey: description}];
}
...
+ (instancetype)KIFErrorWithUnderlyingError:(NSError *)underlyingError format:(NSString *)format, ...
{
    ...
    return [self errorWithDomain:@"KIFTest" code:1234 userInfo:userInfo];
}
